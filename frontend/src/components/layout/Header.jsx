...
// import server from "../../constants/config";
// import { userNotExists } from "../../redux-toolkit/reducers/reducerAuth";
// import { crimson } from "../../constants/color"; // Custom color
...
//   const logoutUser = async () => {
//     try {
//       const { data } = await axios.post(`${server}/api/v1/auth/logout`, {
//         withCredentials: true,
//       });
...
//           position="static"
//           sx={{
//             bgcolor: `linear-gradient(90deg, ${crimson} 30%, #ff8a80 90%)`,
...
//           },
//           "&:active": {
//             transform: "scale(1.15)", // Reduced size when clicked
//             color: "#e53935", // Darker shade when clicked
//             boxShadow: "0 4px 8px rgba(0, 0, 0, 0.2)", // Reduced shadow on click
//           },
//         }}
//       >
